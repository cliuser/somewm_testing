...
-- Icon directory path
local icondir = require('src.theme.user_variables').icon_dir .. 'brightness/'

BACKLIGHT_MAX_BRIGHTNESS = 0
BACKLIGHT_SEPS = 0
awful.spawn.easy_async_with_shell(
--	[[ "lsmod | fgrep -q vboxguest && echo 61167 || pkexec xfpm-power-backlight-helper --get-max-brightness" ]],
	[[ echo 61167 ]],
  function(stdout)
...
return function(s)
  ...
  brightness_osd_widget.container.osd_layout.icon_slider_layout.slider_layout.brightness_slider:connect_signal(
    ...
    function()
    awful.spawn.easy_async_with_shell(
--      [[ "lsmod | fgrep vboxguest && echo 46016 || pkexec xfpm-power-backlight-helper --get-brightness" ]],
      	[[ echo 46016 ]],
      function(stdout)
  ...
  local update_slider = function()
    awful.spawn.easy_async_with_shell(
--	  [[ "lsmod | fgrep -q vboxguest && echo 46016 || pkexec xfpm-power-backlight-helper --get-brightness" ]],
      	[[ echo 46016 ]],
      function(stdout)
